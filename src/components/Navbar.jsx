    ...
    return (
        ...
        <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4' >
            ...
            <div className='bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px]'>
                ...
                <input className='bg-transparent p-2 focus:outline-none' type='text'
                    placeholder='Search foods' />
            </div>
            {/* add cart */}
            <button className='items-center bg-black text-white hidden md:flex sm:text-0.5xl lg:text-1.5xl py-2 rounded-full'>
